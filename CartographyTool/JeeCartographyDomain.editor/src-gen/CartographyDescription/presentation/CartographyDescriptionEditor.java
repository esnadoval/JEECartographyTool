...
/**
 * This is an example of a CartographyDescription model editor.
 * 
 */
public class CartographyDescriptionEditor extends InteractiveEEFEditor {
		...
		try {
			{
				...
				{
					final EEFTreeMDFormPage page = new EEFTreeMDFormPage(CartographyDescriptionEditor.this, "main") {
						...
						public void createPartControl(Composite parent) {
							...
							getModelViewer().addSelectionChangedListener(new ISelectionChangedListener() {
								...
								public void selectionChanged(SelectionChangedEvent selectionChangedEvent) {
									CartographyDescriptionEditor.this.setSelection(selectionChangedEvent.getSelection());
								}
							}
