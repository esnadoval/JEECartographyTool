...
/**
 * This is the item provider adapter for a {@link CartographyDescription.VarType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VarTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VarType_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VarType_name_feature", "_UI_VarType_type"),
				 CartographyDescriptionPackage.Literals.VAR_TYPE__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((VarType)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VarType.class)) {
			case CartographyDescriptionPackage.VAR_TYPE__NAME:
