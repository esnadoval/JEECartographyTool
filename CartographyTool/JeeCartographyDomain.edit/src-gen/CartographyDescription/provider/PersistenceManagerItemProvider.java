...
/**
 * This is the item provider adapter for a {@link CartographyDescription.PersistenceManager} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PersistenceManagerItemProvider extends ClassItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PersistenceManagerItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PersistenceManager_persistenceType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PersistenceManager_persistenceType_feature", "_UI_PersistenceManager_type"),
				 CartographyDescriptionPackage.Literals.PERSISTENCE_MANAGER__PERSISTENCE_TYPE,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns PersistenceManager.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PersistenceManager"));
	}
	...
	public String getText(Object object) {
		String label = ((PersistenceManager)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_PersistenceManager_type") :
			getString("_UI_PersistenceManager_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PersistenceManager.class)) {
