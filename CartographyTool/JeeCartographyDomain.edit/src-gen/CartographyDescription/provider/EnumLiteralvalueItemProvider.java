...
/**
 * This is the item provider adapter for a {@link CartographyDescription.EnumLiteralvalue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumLiteralvalueItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CartographyDescriptionPackage.Literals.ENUM_LITERALVALUE__VALUE,
				 true,
				 false,
				 false,
	...
	protected void addAttrPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EnumLiteralvalue_attr_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EnumLiteralvalue_attr_feature", "_UI_EnumLiteralvalue_type"),
				 CartographyDescriptionPackage.Literals.ENUM_LITERALVALUE__ATTR,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((EnumLiteralvalue)object).getValue();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EnumLiteralvalue.class)) {
