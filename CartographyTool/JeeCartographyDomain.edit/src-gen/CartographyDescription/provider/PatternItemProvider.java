...
/**
 * This is the item provider adapter for a {@link CartographyDescription.Pattern} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PatternItemProvider extends CartographyElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Pattern_modules_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Pattern_modules_feature", "_UI_Pattern_type"),
				 CartographyDescriptionPackage.Literals.PATTERN__MODULES,
				 true,
				 false,
				 true,
				 null,
