...
/**
 * This is the item provider adapter for a {@link CartographyDescription.Variable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CartographyDescriptionPackage.Literals.VARIABLE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addInhertancePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variable_inhertance_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variable_inhertance_feature", "_UI_Variable_type"),
				 CartographyDescriptionPackage.Literals.VARIABLE__INHERTANCE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addStaticPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variable_static_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variable_static_feature", "_UI_Variable_type"),
				 CartographyDescriptionPackage.Literals.VARIABLE__STATIC,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CartographyDescriptionPackage.Literals.VARIABLE__TYPE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CartographyDescriptionPackage.Literals.VARIABLE__TYPE,
