...
/**
 * This is the item provider adapter for a {@link CartographyDescription.UnitTest} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnitTestItemProvider extends ClassItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UnitTest_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UnitTest_type_feature", "_UI_UnitTest_type"),
				 CartographyDescriptionPackage.Literals.UNIT_TEST__TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((UnitTest)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_UnitTest_type") :
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UnitTest.class)) {
			case CartographyDescriptionPackage.UNIT_TEST__TYPE:
