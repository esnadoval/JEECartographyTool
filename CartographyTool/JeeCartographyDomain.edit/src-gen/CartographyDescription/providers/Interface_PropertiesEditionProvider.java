...
import CartographyDescription.components.InterfacePropertiesEditionComponent;
...
public class Interface_PropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof Interface) 
					&& (CartographyDescriptionPackage.Literals.INTERFACE == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && CartographyDescriptionPackage.Literals.INTERFACE == eObj.eClass();
		}
