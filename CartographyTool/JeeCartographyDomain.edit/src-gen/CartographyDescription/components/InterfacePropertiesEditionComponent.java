...
public class InterfacePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public InterfacePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject interface_, String editing_mode) {
		...
		partKey = CartographyDescriptionViewsRepository.Interface_.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.locs)) {
				basePart.setLocs(EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG, interface_.getLocs()));
			}
			
			if (isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.comments)) {
				basePart.setComments(EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG, interface_.getComments()));
			}
			
			if (isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.anotations)) {
				anotationsSettings = new ReferencesTableSettings(interface_, CartographyDescriptionPackage.eINSTANCE.getAnnotatedObject_Anotations());
				basePart.initAnotations(anotationsSettings);
			}
			if (isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.weight)) {
				basePart.setWeight(EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG, interface_.getWeight()));
			}
			
			if (isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, interface_.getName()));
			
			if (isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.maxWeight)) {
				basePart.setMaxWeight(EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG, interface_.getMaxWeight()));
			}
			
			if (isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.migRelations)) {
				migRelationsSettings = new ReferencesTableSettings(interface_, CartographyDescriptionPackage.eINSTANCE.getCartographyElement_MigRelations());
				basePart.initMigRelations(migRelationsSettings);
			}
			if (isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.parentLayer)) {
				// init part
				parentLayerSettings = new EObjectFlatComboSettings(interface_, CartographyDescriptionPackage.eINSTANCE.getCartographyElement_ParentLayer());
				basePart.initParentLayer(parentLayerSettings);
				// set the button mode
				basePart.setParentLayerButtonMode(ButtonsModeEnum.BROWSE);
			}
			if (isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.parentModule)) {
				// init part
				parentModuleSettings = new EObjectFlatComboSettings(interface_, CartographyDescriptionPackage.eINSTANCE.getCartographyElement_ParentModule());
				basePart.initParentModule(parentModuleSettings);
				// set the button mode
				basePart.setParentModuleButtonMode(ButtonsModeEnum.BROWSE);
			}
			if (isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.originalFilePath))
				basePart.setOriginalFilePath(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, interface_.getOriginalFilePath()));
			
			if (isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.newFilePath))
				basePart.setNewFilePath(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, interface_.getNewFilePath()));
			
			if (isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.visibility)) {
				basePart.initVisibility(EEFUtils.choiceOfValues(interface_, CartographyDescriptionPackage.eINSTANCE.getClass_Visibility()), interface_.getVisibility());
			}
			if (isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.attributes)) {
				attributesSettings = new ReferencesTableSettings(interface_, CartographyDescriptionPackage.eINSTANCE.getClass_Attributes());
				basePart.initAttributes(attributesSettings);
			}
			if (isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.methods)) {
				methodsSettings = new ReferencesTableSettings(interface_, CartographyDescriptionPackage.eINSTANCE.getClass_Methods());
				basePart.initMethods(methodsSettings);
			}
			if (isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.inhertance)) {
				basePart.initInhertance(EEFUtils.choiceOfValues(interface_, CartographyDescriptionPackage.eINSTANCE.getClass_Inhertance()), interface_.getInhertance());
			}
			if (isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.implements_)) {
				implements_Settings = new ReferencesTableSettings(interface_, CartographyDescriptionPackage.eINSTANCE.getClass_Implements());
				basePart.initImplements_(implements_Settings);
			}
			if (isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.originalFileName))
				basePart.setOriginalFileName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, interface_.getOriginalFileName()));
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == CartographyDescriptionViewsRepository.Interface_.Properties.locs) {
			return CartographyDescriptionPackage.eINSTANCE.getStaticMetrics_Locs();
		}
		if (editorKey == CartographyDescriptionViewsRepository.Interface_.Properties.comments) {
			return CartographyDescriptionPackage.eINSTANCE.getStaticMetrics_Comments();
		}
		if (editorKey == CartographyDescriptionViewsRepository.Interface_.Properties.anotations) {
			return CartographyDescriptionPackage.eINSTANCE.getAnnotatedObject_Anotations();
		}
		if (editorKey == CartographyDescriptionViewsRepository.Interface_.Properties.weight) {
			return CartographyDescriptionPackage.eINSTANCE.getCartographyElement_Weight();
		}
		if (editorKey == CartographyDescriptionViewsRepository.Interface_.Properties.name) {
			return CartographyDescriptionPackage.eINSTANCE.getCartographyElement_Name();
		}
		if (editorKey == CartographyDescriptionViewsRepository.Interface_.Properties.maxWeight) {
			return CartographyDescriptionPackage.eINSTANCE.getCartographyElement_MaxWeight();
		}
		if (editorKey == CartographyDescriptionViewsRepository.Interface_.Properties.migRelations) {
			return CartographyDescriptionPackage.eINSTANCE.getCartographyElement_MigRelations();
		}
		if (editorKey == CartographyDescriptionViewsRepository.Interface_.Properties.parentLayer) {
			return CartographyDescriptionPackage.eINSTANCE.getCartographyElement_ParentLayer();
		}
		if (editorKey == CartographyDescriptionViewsRepository.Interface_.Properties.parentModule) {
			return CartographyDescriptionPackage.eINSTANCE.getCartographyElement_ParentModule();
		}
		if (editorKey == CartographyDescriptionViewsRepository.Interface_.Properties.originalFilePath) {
			return CartographyDescriptionPackage.eINSTANCE.getCartographyElement_OriginalFilePath();
		}
		if (editorKey == CartographyDescriptionViewsRepository.Interface_.Properties.newFilePath) {
			return CartographyDescriptionPackage.eINSTANCE.getCartographyElement_NewFilePath();
		}
		if (editorKey == CartographyDescriptionViewsRepository.Interface_.Properties.visibility) {
			return CartographyDescriptionPackage.eINSTANCE.getClass_Visibility();
		}
		if (editorKey == CartographyDescriptionViewsRepository.Interface_.Properties.attributes) {
			return CartographyDescriptionPackage.eINSTANCE.getClass_Attributes();
		}
		if (editorKey == CartographyDescriptionViewsRepository.Interface_.Properties.methods) {
			return CartographyDescriptionPackage.eINSTANCE.getClass_Methods();
		}
		if (editorKey == CartographyDescriptionViewsRepository.Interface_.Properties.inhertance) {
			return CartographyDescriptionPackage.eINSTANCE.getClass_Inhertance();
		}
		if (editorKey == CartographyDescriptionViewsRepository.Interface_.Properties.implements_) {
			return CartographyDescriptionPackage.eINSTANCE.getClass_Implements();
		}
		if (editorKey == CartographyDescriptionViewsRepository.Interface_.Properties.originalFileName) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (CartographyDescriptionViewsRepository.Interface_.Properties.locs == event.getAffectedEditor()) {
			interface_.setLocs((EEFConverterUtil.createLongFromString(EcorePackage.Literals.ELONG, (String)event.getNewValue())));
		}
		if (CartographyDescriptionViewsRepository.Interface_.Properties.comments == event.getAffectedEditor()) {
			interface_.setComments((EEFConverterUtil.createLongFromString(EcorePackage.Literals.ELONG, (String)event.getNewValue())));
		}
		if (CartographyDescriptionViewsRepository.Interface_.Properties.anotations == event.getAffectedEditor()) {
		...
		if (CartographyDescriptionViewsRepository.Interface_.Properties.weight == event.getAffectedEditor()) {
			interface_.setWeight((EEFConverterUtil.createLongFromString(EcorePackage.Literals.ELONG, (String)event.getNewValue())));
		}
		if (CartographyDescriptionViewsRepository.Interface_.Properties.name == event.getAffectedEditor()) {
		...
		if (CartographyDescriptionViewsRepository.Interface_.Properties.maxWeight == event.getAffectedEditor()) {
			interface_.setMaxWeight((EEFConverterUtil.createLongFromString(EcorePackage.Literals.ELONG, (String)event.getNewValue())));
		}
		if (CartographyDescriptionViewsRepository.Interface_.Properties.migRelations == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (CartographyDescriptionViewsRepository.Interface_.Properties.parentLayer == event.getAffectedEditor()) {
		...
		if (CartographyDescriptionViewsRepository.Interface_.Properties.parentModule == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
		...
		if (CartographyDescriptionViewsRepository.Interface_.Properties.originalFilePath == event.getAffectedEditor()) {
			interface_.setOriginalFilePath((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (CartographyDescriptionViewsRepository.Interface_.Properties.newFilePath == event.getAffectedEditor()) {
			interface_.setNewFilePath((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (CartographyDescriptionViewsRepository.Interface_.Properties.visibility == event.getAffectedEditor()) {
			interface_.setVisibility((Visibility)event.getNewValue());
		}
		if (CartographyDescriptionViewsRepository.Interface_.Properties.attributes == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (CartographyDescriptionViewsRepository.Interface_.Properties.methods == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (CartographyDescriptionViewsRepository.Interface_.Properties.inhertance == event.getAffectedEditor()) {
			interface_.setInhertance((Inhertance)event.getNewValue());
		}
		if (CartographyDescriptionViewsRepository.Interface_.Properties.implements_ == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (CartographyDescriptionViewsRepository.Interface_.Properties.originalFileName == event.getAffectedEditor()) {
			interface_.setOriginalFileName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
	}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (CartographyDescriptionPackage.eINSTANCE.getStaticMetrics_Locs().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.locs)) {
			...
			if (CartographyDescriptionPackage.eINSTANCE.getStaticMetrics_Comments().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.comments)) {
				if (msg.getNewValue() != null) {
			...
			if (CartographyDescriptionPackage.eINSTANCE.getAnnotatedObject_Anotations().equals(msg.getFeature()) && isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.anotations))
				basePart.updateAnotations();
			if (CartographyDescriptionPackage.eINSTANCE.getCartographyElement_Weight().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.weight)) {
				if (msg.getNewValue() != null) {
			...
			if (CartographyDescriptionPackage.eINSTANCE.getCartographyElement_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.name)) {
				if (msg.getNewValue() != null) {
			...
			if (CartographyDescriptionPackage.eINSTANCE.getCartographyElement_MaxWeight().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.maxWeight)) {
				if (msg.getNewValue() != null) {
			...
			if (CartographyDescriptionPackage.eINSTANCE.getCartographyElement_MigRelations().equals(msg.getFeature())  && isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.migRelations))
				basePart.updateMigRelations();
			if (CartographyDescriptionPackage.eINSTANCE.getCartographyElement_ParentLayer().equals(msg.getFeature()) && basePart != null && isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.parentLayer))
				basePart.setParentLayer((EObject)msg.getNewValue());
			if (CartographyDescriptionPackage.eINSTANCE.getCartographyElement_ParentModule().equals(msg.getFeature()) && basePart != null && isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.parentModule))
				basePart.setParentModule((EObject)msg.getNewValue());
			if (CartographyDescriptionPackage.eINSTANCE.getCartographyElement_OriginalFilePath().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.originalFilePath)) {
				if (msg.getNewValue() != null) {
			...
			if (CartographyDescriptionPackage.eINSTANCE.getCartographyElement_NewFilePath().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.newFilePath)) {
				if (msg.getNewValue() != null) {
			...
			if (CartographyDescriptionPackage.eINSTANCE.getClass_Visibility().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.visibility))
				basePart.setVisibility((Visibility)msg.getNewValue());
			
			if (CartographyDescriptionPackage.eINSTANCE.getClass_Attributes().equals(msg.getFeature()) && isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.attributes))
				basePart.updateAttributes();
			if (CartographyDescriptionPackage.eINSTANCE.getClass_Methods().equals(msg.getFeature()) && isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.methods))
				basePart.updateMethods();
			if (CartographyDescriptionPackage.eINSTANCE.getClass_Inhertance().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.inhertance))
				basePart.setInhertance((Inhertance)msg.getNewValue());
			
			if (CartographyDescriptionPackage.eINSTANCE.getClass_Implements().equals(msg.getFeature()) && isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.implements_))
				basePart.updateImplements_();
			if (CartographyDescriptionPackage.eINSTANCE.getClass_OriginalFileName().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(CartographyDescriptionViewsRepository.Interface_.Properties.originalFileName)) {
				if (msg.getNewValue() != null) {
