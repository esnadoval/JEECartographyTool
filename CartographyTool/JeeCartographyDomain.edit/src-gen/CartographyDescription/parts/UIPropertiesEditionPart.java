 ...
 * 
 */
public interface UIPropertiesEditionPart {
	...
	/**
	 * Defines a new frameworkType
	 * @param newValue the new frameworkType to set
	 * 
	 */
	...
	/**
	 * @return the forDevice
	 * 
	 */
	public String getForDevice();

	/**
	 * Defines a new forDevice
	 * @param newValue the new forDevice to set
	 * 
	 */
