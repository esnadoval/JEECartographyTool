 ...
 * 
 */
public interface ConstructorPropertiesEditionPart {
	 ...
	 * @param newValue the exceptions to update
	 * 
	 */
	public void updateExceptions();

	/**
	 * Adds the given filter to the exceptions edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the exceptions table
	 * 
	 */
