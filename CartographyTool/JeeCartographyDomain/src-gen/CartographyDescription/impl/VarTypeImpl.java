 ...
 * </p>
 * <ul>
 *   <li>{@link CartographyDescription.impl.VarTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VarTypeImpl extends MinimalEObjectImpl.Container implements VarType {
	...
	protected EClass eStaticClass() {
		return CartographyDescriptionPackage.Literals.VAR_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CartographyDescriptionPackage.VAR_TYPE__NAME, oldName, name));
	}
