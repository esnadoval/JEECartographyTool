 ...
 * </p>
 * <ul>
 *   <li>{@link CartographyDescription.impl.EnumerationImpl#getLiterals <em>Literals</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumerationImpl extends ClassImpl implements Enumeration {
	...
	protected EClass eStaticClass() {
		return CartographyDescriptionPackage.Literals.ENUMERATION;
	}
	...
	public EList<EnumLiteral> getLiterals() {
		if (literals == null) {
			literals = new EObjectContainmentEList<EnumLiteral>(EnumLiteral.class, this, CartographyDescriptionPackage.ENUMERATION__LITERALS);
		}
		return literals;
	}
